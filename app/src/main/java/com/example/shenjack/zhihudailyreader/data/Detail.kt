...
class Detail {
     ...
     *
     * 另外，似乎知道了 Zara&nbsp;和 H&amp;M 一直被外界冠以环境污染的罪名，GAP 的联合创始人 Doris 和 Don Fisher 有意发起了DO MORE THAN SELL CLOTHES的倡议，似乎更要采用有机棉去促进农业可持续性生产，希望能够以品牌的社会使命唤起人们的品牌意识，重新树立品牌形象。
     *
     ...
     * -------------------------
     *
     * &nbsp;H&amp;M，另一个巨人。同样十分优秀的 fast fashion 品牌，在模式上面来说，更加倾向于兼顾出货时间和产品成本，因此速度不及 Zara，但是依靠着成本领先优势也在这一行业占有一席之地。时尚程度也不及 Zara，毕竟人家 Zara&nbsp;也是抄大牌啊，而且抄到了精髓。H&amp;M 是欧洲这边屌丝青年的首选，最近的设计偏街头，什么大印花，牛仔，大字母，大迷彩产品缺点也很明显，质量不敢恭维，面料算是这四个品牌里面最差劲得了（洗过一次就知道了）。但是和 Zara&nbsp;一样，都是把服装从耐用消费品变革为快速消费品的革新者，因此质量也就不那么重要了。
     *
     ...
     *
     * <img src="http://p1.zhimg.com/4a/a0/4aa08b8df11bd548a4e8001c01147254_m.jpg" alt=""></img>
     *
     * 另外一点，H&amp;M 在尺码的选择上有更多选择，甚至还有很多是为了准妈妈而量身定制的。下图是英国的 H&amp;M 的附加尺码的统计和当地主要竞争品牌的对比：
     *
     * <img src="http://p3.zhimg.com/8c/77/8c77261db9770994738e521725f01837_m.jpg" alt=""></img>
     *
     ...
     *
     * 3. 细节：和无印良品一样，店铺的细节要求到极致，所有衣服叠放的方式均是十分讲究，比如可以使顾客很容易就看到裤腿宽窄的叠法。另一个细节我不得不说，相信很多人都忽略了，就是镜子。在国内，优衣库的镜子照出来的人和 GAP，H&amp;M 以及 Zara&nbsp;的镜子照出来的效果完全不一样。其中一部分是因为镜子的摆放，另一部分是因为灯光。因为黄种人轮廓，尤其是脸部轮廓不深，相比于欧美人更加平，因此其实黄种人并不适合灯光直接从上面打下来的照出来的效果，那样会将脸部轮廓的缺陷通过阴影完全展现出来，然而轮廓较深的欧美人则可以展现出立体的骨骼轮廓。因此，在照镜子的时候灯光从前面或者后面斜照下来更适用于黄种人。同时灯光的选择也恰到好处，不黄，不刺眼，光线柔和，可以烘托甚至美化出肤质。
     *
    ...
    var type: Int = 0
    var id: Int = 0
    private var js: List<String>? = null
    var images: List<String>? = null
    var css: List<String>? = null

    fun getJs(): List<String>? {
        return js
    }

    fun setJs(js: List<String>) {
        this.js = js
    }
}
