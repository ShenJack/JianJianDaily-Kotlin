...
class TodayStories : Serializable {
    private val date: String? = null


    @SerializedName("stories")
    var storiesX: List<StoriesBean>? = null
    @SerializedName("top_stories")
    var top_storiesX: List<TopStoriesBean> = ArrayList()
    ...
    class TopStoriesBean {
         ...
         * <div class="meta">
         * <img class="avatar" src="http://pic1.zhimg.com/82d2a64137b4301c1f73458edd473a98_is.jpg"></img>
         * <span class="author">顾剑，</span><span class="bio">学而不思则罔，思而不学则殆。我既不学也不思，看来安全了。</span>
        </div> *

         * <div class="content">
         *
         * **校园贷不仅仅是校园贷，某种意义上是代表着一种未来的方向。**堵不如疏的道理大家都懂。
         *
         * 在国内监管并不是独立的事情，不是每个受监管的对象都是敌人只能用政策去调控去防范风险，完全可以配合讲政治的国家队所承担的社会责任促进发展。
         *
         * **1、大环境向消费型社会转型。**学校相对独立于社会，但是必然受到社会影响，何况现在由于移动互联网的广泛普及，校园想封闭也封闭不起来。无论如何都会有消费需求的话，提供低息贷款，不让本来有可能拯救的群体打着滚掉进高息小额贷的坑里是很有意义的，国家队的校园贷可以考虑整体与长远，在这方面只从每笔业务的角度看待学生群体缺乏第一还款来源看待并不合适，望远镜角度下的视角肯定不同于显微镜下。
         *
         ...
         * <div class="view-more">[查看知乎讨论<span class="js-question-holder"></span>](http://www.zhihu.com/question/60495516)</div>
